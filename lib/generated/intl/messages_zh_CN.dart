...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m4(count) => "获取到${count}个表情";

  static String m5(error) => "获取表情失败: ${error}";

  static String m6(season, period, formattedTime, weather, window) =>
  ...
  static String m20(windowName) => "我正在浏览的窗口是：${windowName}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "downloadFile": m3,
        "downloadInfo":
            MessageLookupByLibrary.simpleMessage("下载完成后将自动安装并启动Kage"),
        ...
        "ghProxyHint":
            MessageLookupByLibrary.simpleMessage("通过ghproxy代理加速下载，适用于中国大陆网络"),
        ...
        "kageNotFound":
            MessageLookupByLibrary.simpleMessage("未检测到Kage程序，是否下载最新版本？"),
